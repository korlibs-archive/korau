...
class SyncState {
    ...
    fun buffer(size: Int): Int {
        ...
        if (dataOffset != 0) {
            ...
            if (bufferOffset > 0) {
                data.copyRangeTo(dataOffset, data, 0, bufferOffset)
            }
            dataOffset = 0
        }
        ...
        if (size > storage - bufferOffset) {
            ...
            if (data != null) {
                ...
                data.copyRangeTo(0, foo, 0, data.size)
                data = foo
            } else {
    ...
    fun pageseek(og: Page?): Int {
        ...
        val result = synchronized(chksum) {
            ...
            data.copyRangeTo(page + 22, chksum, 0, 4)
            data[page + 22] = 0
            data[page + 23] = 0
            data[page + 24] = 0
            data[page + 25] = 0
            ...
            if (chksum[0] != data[page + 22] || chksum[1] != data[page + 23] || chksum[2] != data[page + 24] || chksum[3] != data[page + 25]) {
                ...
                chksum.copyRangeTo(0, data, page + 22, 4)
