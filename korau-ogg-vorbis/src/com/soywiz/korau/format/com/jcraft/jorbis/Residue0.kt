...
internal open class Residue0 : FuncResidue() {
    ...
    override fun look(vd: DspState, vm: InfoMode, vr: Any): Any {
        ...
        look.partvals = Math.rint(Math.pow(look.parts.toDouble(), dim.toDouble())).toInt()
    ...
    companion object {
        ...
        // re-using partword
        @Synchronized fun _01inverse(vb: Block, vl: Any, `in`: Array<FloatArray>, ch: Int,
                                     decodepart: Int): Int {
            var i: Int
            var j: Int
            var k: Int
        ...
        @Synchronized fun _2inverse(vb: Block, vl: Any, `in`: Array<FloatArray>, ch: Int): Int {
            var i: Int
            var k: Int
            var l: Int
            var s: Int
