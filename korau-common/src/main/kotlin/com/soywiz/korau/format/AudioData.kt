...
suspend fun VfsFile.readAudioData(formats: AudioFormats = defaultAudioFormats) = this.openUse { formats.decode(this) ?: invalidOp("Can't decode audio file ${this@readAudioData}") }